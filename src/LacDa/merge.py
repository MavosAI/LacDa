...
def dequantize_model(model, tokenizer, to, dtype=torch.float16, device="cuda", save_model=False):
    """
...
def merge():
    ...
    bnb_config = BitsAndBytesConfig(
        ...
        bnb_4bit_compute_dtype=torch.float16,  # "bfloat16/float16"Specify the data type to use for computations during 4-bit quantization bfloat16 claim that faster training than float16
    ...
    model = dequantize_model(model, tokenizer, to=f"lacda-2-7B-chat-v0.1-dequantized")
